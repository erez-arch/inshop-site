      ...
      <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${scrolled ? "bg-[#0e1b2a]/90 backdrop-blur-2xl border-b border-[#1c3350] shadow-[0_2px_20px_rgba(0,100,200,0.06)]" : ""}`}>
        <div className="max-w-7xl mx-auto px-6 md:px-10 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            {/* Version switcher */}
            <div className="flex items-center gap-0.5 border border-[#1c3350] rounded-full p-0.5 bg-[#0a1520]">
              <span className="text-[10px] font-mono px-2.5 py-1.5 rounded-full bg-[#00A1E0]/15 text-[#00A1E0] font-bold">V1</span>
              <Link href="/v2" className="text-[10px] font-mono px-2.5 py-1.5 rounded-full text-white/30 hover:text-white/70 transition-colors">V2</Link>
              <Link href="/v3" className="text-[10px] font-mono px-2.5 py-1.5 rounded-full text-white/30 hover:text-white/70 transition-colors">V3</Link>
              <Link href="/v5" className="text-[10px] font-mono px-2.5 py-1.5 rounded-full text-white/30 hover:text-white/70 transition-colors">V5</Link>
              <Link href="/v6" className="text-[10px] font-mono px-2.5 py-1.5 rounded-full text-white/30 hover:text-white/70 transition-colors">V6</Link>
            </div>
            {/* Language toggle */}
            <button
